...
import location from '../../../assets/newassets/location-merchant.png';

const BeMerchant = () => {
    return (
        <div data-aos="flip-left" className="bg-[url('assets/be-a-merchant-bg.png')] bg-no-repeat bg-[#03373D] rounded-4xl p-20 -mt-9 mb-2 text-white">
