...
const BeARider = () => {
    ...
    const onSubmit = async (data) => {
        const riderData = {
            ...
            name: user?.displayName || user?.name || "", // উভয় ধরনের ব্যবহারকারীর নাম নিন
            email: user?.email || "",
            status: "pending",
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <div className="grid grid-cols-1 gap-4">
                    ...
                    {/* <input
                        ...
                        readOnly
                        className="input input-bordered text-green-400 w-full bg-gray-100"
                    /> */}
                    
                    {/* <input
                        type="text"
                        
                           defaultValue={user?.displayName || user?.name || user?.username || "Your Name"}  
                 ...
                 className="input input-bordered text-green-400 w-full bg-gray-100"
                  ...
                  /> */}
                    ...
                    <input
                        ...
                        readOnly
                        className="input input-bordered text-green-500 w-full bg-gray-100"
                    />
                ...
                <button type="submit" className="btn btn-neutral text-white w-full mt-4">
...
// _id
// 689cd63b24adaae1ac2e3049
// email
// "rider2025@gmail.com"
// role
// "user"
// name
// "rider2025" this not show why ?????????????
// photo
// "https://i.ibb.co/TM4NBdL7/frogimage5.jpg"
// created_at
// "2025-08-13T18:15:22.738Z"
// last_log_in
// "2025-08-13T18:15:22.738Z"